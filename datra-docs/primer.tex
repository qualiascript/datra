...
% TODO: fix/improve explanation below
...
\((B := 2) \HorSum (C := 6)\). It can be clearly seen that one can
...
for instance,
\(A \HorSum B \HorSum C = \code{[A; B; C]}\). A variation
...
\begin{tikzpicture}[node distance=12mm]
  ...
  \node[font=\Large,right=12mm of bsource] (plus) {\(\HorSum\)};
